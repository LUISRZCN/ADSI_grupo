...
while True:
  ...
  if accion<1 or accion>4:
    ...
    idActualizar=int(input('Ingrese el ID de la tarea que desea actualizar: '))
    print('\n** Nuevo titulo **\n** Nota: si no desea actualizar el titulo solo oprima ENTER **')
    datosActualizados['titulo']=input('Ingrese el nuevo titulo de la tarea: ')
    print('\n** Nueva descripcion **\n** Nota: si no desea actualizar la descripcion solo oprima ENTER **')
    datosActualizados['descripcion']=input('Ingrese la nueva descripcion de la tarea: ')
